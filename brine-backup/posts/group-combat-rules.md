...
When groups fight, _zoom out_. Use the following threat levels to track the situation: 
...
Roll `2d6` (as per [OYAB](https://brine.dev/posts/of_yarn_and_bone)) - high die for success, low die compared to threat level for impact:
